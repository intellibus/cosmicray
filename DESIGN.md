...
- [cosmicray design](#cosmicray-design)
...
`cosmicray` is designed to be a set of standard configuration templates for `syncpad`.

## How is it different from what I already use?

**WORK IN PROGRESS**: `cosmicray` is still in the `design` phase.
...
`cosmicray` is a part of the [Open Source Universe](https://github.com/intellibus/approach). All Projects in the [Open Source Universe](https://github.com/intellibus/approach) follow the same [Contribution Guidelines & Process](https://github.com/intellibus/approach).
...
`cosmicray` only plans to initially support Typescript & JavaScript Applications. However, we would love for the community to contribute versions for other languages (Java, Go, etc.)
